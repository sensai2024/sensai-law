      ...
      <div className="z-10 flex flex-col items-center gap-8">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-12 h-12 bg-[var(--surface)] border border-[var(--border)] rounded-xl flex items-center justify-center shadow-gold-glow animate-pulse">
        ...
        <div className="text-center">
          <h3 className="text-[var(--text)] font-bold tracking-[0.2em] uppercase text-xs">Altata Légal</h3>
          <p className="text-[10px] text-[var(--text-muted)] mt-2 font-medium tracking-widest uppercase animate-pulse">{message}</p>
        </div>
      </div>
    </div>
  );
