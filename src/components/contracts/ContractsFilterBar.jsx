...
const ContractsFilterBar = ({ filters, onFilterChange }) => {
    return (
        <div className="flex flex-col md:flex-row gap-4 mb-6 justify-between items-center">
            ...
            <div className="flex gap-3 w-full md:w-auto overflow-x-auto pb-1 md:pb-0">
                <select
                    ...
                    className="bg-surface border border-white/10 rounded-md px-3 py-2 text-sm text-text-secondary focus:outline-none hover:border-white/20 cursor-pointer"
                >
